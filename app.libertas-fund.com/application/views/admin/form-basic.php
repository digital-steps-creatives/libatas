            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                                                            <div class="form-group" app-field-wrapper="date"><label for="date" class="control-label">Date</label><div class="input-group date"><input type="text" id="date" name="date" class="form-control datepicker"  value="<?echo $value['datecreated']; ?>" autocomplete="off"><div class="input-group-addon">
    ...
    <i class="fa fa-calendar calendar-icon"></i>
                     ...
                     <div class="col-md-6">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                                                            <div class="form-group" app-field-wrapper="phone"><label for="phone" class="control-label">Phone</label><input type="text" id="phone" name="phone" class="form-control"  value="<?echo $value['phonenumber']; ?>"></div>                           </div>
