...
<div id="wrapper">
   <div class="content accounting-template proposal">
      <div class="row">
         <?php
            ...
            ?>
         <?php echo form_open($this->uri->uri_string(),array('id'=>'proposal-formd','class'=>'_transaction_form proposal-form')); ?>
         <div class="col-md-12">
            <div class="panel_s">
            ...
            <input type="text" id="titles" name="titles" class="form-control"  value="" disabled>
            </div>
            </div>
            <div class="col-md-6">
            ...
            <input type="text" id="surname" name="surname" class="form-control" value="" disabled>
            </div>
            </div>
            <div class="col-md-6">
            <div class="form-group">
            ...
            <input type="text"  name="client_name" class="form-control"  value="" disabled>
            </div>
            </div>
            <div class="col-md-6">
            <div class="form-group">
            ...
            <input type="text" name="dob" class="form-control" value="" disabled>
            </div>
            </div>
            <div class="col-md-6">
            ...
            <small class="req text-danger">* </small>Gender</label>
            <input type="text"  name="gender" class="form-control" value="" disabled>
            </div>
            </div>
            <div class="col-md-6">
            <div class="form-group">
            <label for="marital_status" class="control-label">
            <small class="req text-danger">* </small>Marrital Status</label>
            <input type="text" id="marital_status" name="marital_status" class="form-control"  value="" disabled>
            </div>
            </div>
            <div class="col-md-6">
            <div class="form-group">
            ...
            <input type="text" id="contact_number" name="contact_number" class="form-control"  value="" disabled>
            </div>
            </div>
            <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="mail_address" name="mail_address" class="form-control"  value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  ...
  <input type="text" id="cell_number" name="cell_number" class="form-control"  value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  ...
  <input type="text" id="physical_address" name="physical_address" class="form-control" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="beneficiary_email" name="beneficiary_email" class="form-control"  value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="beneficiary_name" name="beneficiary_name" class="form-control"   value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="beneficiary_surname" name="beneficiary_surname" class="form-control" value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="beneficiary_contacts" name="beneficiary_contacts" class="form-control" value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="beneficiary_id_number" name="beneficiary_id_number" class="form-control"  value=""disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="beneficiary_bank_acc" name="beneficiary_bank_acc" class="form-control" value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group" >
  ...
  <input type="text" id="relationship" name="relationship" class="form-control"  value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="identity_type" name="identity_type" class="form-control"  value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="retirement_age" name="retirement_age" class="form-control"  value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="identity_number" name="identity_number" class="form-control" value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group"> 
  ...
  <input type="text" id="country_id_issued" name="country_id_issued" class="form-control" value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  
  <div class="form-group">
  <label for="academic_qualification" class="control-label">
  <small class="req text-danger">* </small>Highest Academic Qualification</label>
  <input type="text" id="academic_qualification" name="academic_qualification" class="form-control" value="" disabled>
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <input type="text" id="clientbank_name" name="clientbank_name" class="form-control" value="" disabled>
  </div>
  </div>
         <div class="col-md-6">
                  <div class="form-group">
                        ...
                        <input type="text" id="clientbank_acc" name="clientbank_acc" class="form-control" value="" disabled>
                  </div>
         </div>
         <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input type="text" id="client_bank_branchcode" name="client_bank_branchcode" class="form-control"  value="" disabled>
                  </div>
         </div>
    ...
    $('body').on('change','#rel_id', function() {
     if($(this).val() != ''){
      $.get(admin_url + 'proposals/get_relation_data_values/' + $(this).val() + '/' + _rel_type.val(), function(response) {
        ...
        $('input[name="titles"]').val(response.titles);
        ...
        $('input[name="gender"]').val(response.gender);
        $('input[name="marital_status"]').val(response.marital_status);
        $('input[name="mail_address"]').val(response.mail_address);
        $('input[name="cell_number"]').val(response.cell_number);
        $('input[name="physical_address"]').val(response.physical_address);
        $('input[name="beneficiary_surname"]').val(response.beneficiary_surname);
        $('input[name="beneficiary_contacts"]').val(response.beneficiary_contacts);
        $('input[name="beneficiary_id_number"]').val(response.beneficiary_id_number);
        $('input[name="beneficiary_bank_acc"]').val(response.beneficiary_bank_acc);
        $('input[name="relationship"]').val(response.relationship);
        $('input[name="identity_type"]').val(response.identity_type);
        $('input[name="retirement_age"]').val(response.retirement_age);
        $('input[name="identity_number"]').val(response.identity_number);
        $('input[name="country_id_issued"]').val(response.country_id_issued);
        $('input[name="academic_qualification"]').val(response.academic_qualification);
        $('input[name="clientbank_name"]').val(response.clientbank_name);
        $('input[name="clientbank_acc"]').val(response.clientbank_acc);
        $('input[name="client_bank_branchcode"]').val(response.client_bank_branchcode);
        $('input[name="beneficiary_email"]').val(response.beneficiary_email);
        $('input[name="contact_number"]').val(response.contact_number);
        $('input[name="beneficiary_name"]').val(response.beneficiary_name);
