...
<div class="horizontal-tabs">
      <ul class="nav nav-tabs profile-tabs row customer-profile-tabs nav-tabs-horizontal" role="tablist">
         ...
         <?php
            ...
            if(total_rows('tblcustomfields',array('fieldto'=>'customers','active'=>1)) > 0 ){
                 $customer_custom_fields = true;
             ?>
         <li role="presentation" class="<?php if($this->input->get('tab') == 'custom_fffields'){echo 'active';}; ?>">
            <a href="#custom_fields" aria-controls="additional_information" role="tab" data-toggle="tab">
            <?php echo do_action('customer_profile_tab_custom_fields_text',_l( 'More Customer Details')); ?>
            </a>
         </li>
         <?php } ?>
      ...
      <div class="tab-content">
         ...
         <div role="tabpanel" class="tab-pane" id="custom_fields">
            ...
            <small class="req text-danger">* </small>Marital Status</label>
  ...
  <select id="academic_qualification" name="academic_qualification" class="form-control select2">
